...
class Cli {
  // TODO: update the vehicles property to accept Truck and Motorbike objects as well - Done line 11
  vehicles: (Car| Truck | Motorbike)[];
  // TODO: You will need to use the Union operator to define additional types for the array - Done line 11
  
  // TODO: See the AbleToTow interface for an example of how to use the Union operator Done line 11
  ...
  createTruck(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        //this is just so i can see the sample code.
        // .then((answers) => {
        //   const car = new Car(
        //     // TODO: The generateVin method is static and should be called using the class name Cli, make sure to use Cli.generateVin() for creating a truck and motorbike as well!
        //     Cli.generateVin(),
...
//I need to make sure findvehicletotow takes in a vehicle.
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        // TODO: add statements to perform the tow action only if the selected vehicle is a truck. Call the findVehicleToTow method to find a vehicle to tow and pass the selected truck as an argument. After calling the findVehicleToTow method, you will need to return to avoid instantly calling the performActions method again since findVehicleToTow is asynchronous.
          ...
          // find the selected vehicle and perform the tow action
          for (let i = 0; i < this.vehicles.length; i++) {
            if (this.vehicles[i].vin === this.selectedVehicleVin) {
